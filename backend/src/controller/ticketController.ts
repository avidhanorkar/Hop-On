...
const createTicket = async (req: AuthRequest, res: Response) => {
    ...
    const {pnr, busName, busNo, seatNo, price, compatibleGender, src, destination, deptDate, arrivalDate, deptTime, arrivalTime} = req.body;
    ...
    try {
        const ticket = new Ticket({
            ...
            deptDate, arrivalDate, deptTime, arrivalTime
        })
